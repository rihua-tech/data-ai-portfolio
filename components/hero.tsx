...
export function Hero() {
  ...
  return (
    <section className="relative flex min-h-[62vh] items-center justify-center px-6 pt-2 pb-6 md:min-h-[66vh]">
      <div
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        <p className="mb-4 font-mono text-lg tracking-widest text-primary uppercase">
        ...
        <p className="mx-auto mt-6 max-w-xl text-pretty text-lg leading-relaxed text-muted-foreground md:text-lg">
          Designing scalable end-to-end data platforms using Python, SQL, Airflow,
          dbt, and modern cloud warehouses.
        </p>
